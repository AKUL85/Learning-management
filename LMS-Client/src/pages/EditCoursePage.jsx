...
export default function EditCoursePage() {
    ...
    if (loading) return <LoadingSpinner message="Retrieving course data..." showNavbar={true} />;
        ...
        <div className="min-h-screen bg-gray-900 text-white">
            ...
            <div className="max-w-4xl mx-auto px-4 pt-28 pb-12">
                ...
                <div className="bg-gray-800 rounded-2xl p-8 border border-gray-700 shadow-xl">
                    <h1 className="text-3xl font-bold text-cyan-400 mb-8">Update Course: {course.title}</h1>
                    ...
                    <form onSubmit={handleUpdate} className="space-y-8">
                        ...
                        >
                            {submitting ? 'Updating...' : <><Save className="w-5 h-5 mr-2" /> Update</>}
                        </button>
