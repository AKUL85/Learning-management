...
export default function InstructorCard({ instructor_name, instructor_bio, total_students = "15,000", total_courses = 5 }) {
  return (
    <motion.div
        ...
        <div className="flex-1">
          ...
          <div className="flex flex-wrap items-center gap-6 mt-5 text-sm">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-gray-300 font-medium">4.8 Instructor Rating</span>
            </div>
            <div className="flex items-center space-x-2">
